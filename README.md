...
После регистрации входим в приложение и видим страницу натсроек:
...
- Synology settings<br>
  ...
  * Логин
  * Пароль
  * OTP, если он есть. Но лучше использовать отдельного пользователя, как указано в разделе <a id="A1">подготовка</a>
...
<a id="B7"></a>
## TODO
- [x] Сделать длительность видеофрагментов настраиваемыми. 
